<div class="header__icons">
    <details-modal class="header__search">
        <details>
            <summary class="header__icon header__icon--search header__icon--summary link focus-inset modal__toggle" role="button">
                <span>
                    <svg xmlns="http://www.w3.org/2000/svg" focusable="false" role="presentation" class="icon icon-account" fill="none" viewBox="0 0 24 24" stroke="#000000" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
                        <circle cx="11" cy="11" r="8"></circle>
                        <line x1="21" y1="21" x2="16.65" y2="16.65"></line>
                    </svg>
                </span>
            </summary>
            <div class="search-modal modal__content gradient" role="dialog" style="z-index: 10000;">
                ...
                <div class="search-modal__content search-modal__content-bottom" tabindex="-1">
                    <predictive-search class="search-modal__form" data-loading-text="Loading..." results="true">
                        <form id="Form_Search_Master" action="/search" method="get" role="search" class="search search-modal__form" data-search-setting='@json(data_get($SYSTEM_SETTING, 'search_setting'))'>
                            <div class="field">
                                <input class="search__input field__input Search-In-Modal" type="search" name="q" value="" placeholder="Search" role="combobox" autocorrect="off" autocomplete="off" autocapitalize="off" spellcheck="false">
    ...
    <a href="{{ route('fe.web.cart.index') }}" class="header__icon header__icon--cart link focus-inset" id="cart-icon-bubble">
        <svg class="icon icon-cart" focusable="false" role="presentation" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" fill="none">
