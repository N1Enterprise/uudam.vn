<quick-add-modal data-overlay-wrapper style="display: none;" class="quick-add-modal" open>
    <div role="dialog" aria-label="User Authentication" aria-modal="true" class="quick-add-modal__content global-settings-popup no-bottom mobile-position-center" tabindex="-1">
        <button id="ModalClose-4441599705221" type="button" class="quick-add-modal__toggle" aria-label="Close">
