                ...
                <details>
                    ...
                    <div class="share-button__fallback motion-reduce">
                        <div class="field">
                            ...
                            <input type="text" class="field__input" id="url" value="{{ route('fe.web.pages.index', ['slug' => data_get($page, 'slug'), 'id' => data_get($page, 'id')]) }}" placeholder="Link" onclick="this.select();" readonly="">
                        ...
                        <button class="share-button__copy no-js-hidden" data-copy-content="{{ route('fe.web.pages.index', ['slug' => data_get($page, 'slug'), 'id' => data_get($page, 'id')]) }}">
