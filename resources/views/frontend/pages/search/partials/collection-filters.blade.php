<aside class="facets-wrapper page-width" id="main-collection-filters" data-id="template--16599720329466__product-grid">
            ...
            <form id="FacetFiltersForm" class="facets__form">
                <div class="facet-filters sorting caption">
                    <div class="facet-filters__field">
                        ...
                        <div class="select">
                            <select name="sort_by" data-collection-linked-inventory="sort_by" class="facet-filters__sort select__select caption-large" id="SortBy">
            ...
            <details class="mobile-facets__disclosure disclosure-has-popup">
                <summary class="mobile-facets__open-wrapper focus-offset" data-collection-mobile-filter-close>
                    <span class="mobile-facets__open" data-collection-mobile-filter-open>
                        <svg class="icon icon-filter" focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="none">
                                ...
                                <div class="mobile-facets__details js-filter">
                                    <div class="mobile-facets__summary">
                                        <div class="mobile-facets__sort">
                                            ...
                                            <div class="select">
                                                <select name="sort_by" data-collection-linked-inventory="sort_by" class="select__select" id="SortBy-mobile">
                                                    <option value="manual" selected="selected">Nổi bật</option>
                                                    <option value="best-selling">Bán chạy nhất</option>
                                                    <option value="title-ascending">Theo bảng chữ cái, A-Z</option>
                                                    <option value="title-descending">Theo bảng chữ cái, Z-A</option>
