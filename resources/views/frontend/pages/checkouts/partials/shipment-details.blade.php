        ...
        <div class="field">
            ...
            <div id="user_address" data-address-id="{{ data_get($address, 'id') }}">
                ...
                <div>
                    ...
                    <button type="button" class="show-modal-add-address" address-editable-btn style="margin-top: 5px; color: #025B50;" data-address-code="{{ data_get($address, 'code') }}">Chỉnh sửa</button>
                    <span>|</span>
                    <button type="button" class="show-modal-add-address" style="color: #025B50;">Thêm mới</button>
                </div>
            </div>
            @else
            <button type="button" class="a-link show-modal-add-address" style="display: flex; align-items: center; color: #025B50;">
                <svg xmlns="http://www.w3.org/2000/svg" fill="#025B50" width="25" height="25" viewBox="0 0 256 256" id="Flat">
