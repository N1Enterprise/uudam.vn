        ...
        <div class="field">
            ...
            <div id="user_address" data-address-id="{{ data_get($address, 'id') }}">
                ...
                <div>
                    ...
                    <button type="button" class="show-modal-add-address" address-editable-btn style="margin-top: 5px; color: #0181b2;" data-address-code="{{ data_get($address, 'code') }}">Chỉnh sửa</button>
                    <span>|</span>
                    <button type="button" class="show-modal-add-address" style="color: #0181b2;">Thêm mới</button>
                </div>
            </div>
            @else
            <button type="button" class="a-link show-modal-add-address" style="display: flex; align-items: center; color: #0181b2;">
