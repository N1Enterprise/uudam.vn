    ...
    <article class="article-template" itemscope>
        <div class="article-template__hero-container">
            <div class="article-template__hero-large media" itemprop="thumbnail" style="background: none; display: flex; justify-content: center; align-items: center;">
                <video style="position: relative; z-index: 1; width: auto;" controls autoplay="true" muted>
                ...
                <details>
                    ...
                    <div class="share-button__fallback motion-reduce">
                        <div class="field">
                            ...
                            <input type="text" class="field__input" id="url" value="{{ route('fe.web.videos.index', ['slug' => data_get($video, 'slug'), 'id' => data_get($video, 'id')]) }}" placeholder="Link" onclick="this.select();" readonly="">
                        ...
                        <button class="share-button__copy no-js-hidden" data-copy-content="{{ route('fe.web.videos.index', ['slug' => data_get($video, 'slug'), 'id' => data_get($video, 'id')]) }}">
