<slideshow-component class="slider-mobile-gutter page-width" aria-label="Slideshow about our brand">
    <div class="slideshow__controls slideshow__controls--top slider-buttons no-js-hidden">
        <button type="button" class="Slider_Home_Banner__prev slider-button slider-button--prev" name="previous" aria-label="Previous slide" aria-controls="Slider-template--16599720624378__1655078171bc129901" data-slick-id="home_banner" data-slick-button-prev>
            <svg aria-hidden="true" focusable="false" role="presentation" class="icon icon-caret" viewBox="0 0 10 6">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M9.354.646a.5.5 0 00-.708 0L5 4.293 1.354.646a.5.5 0 00-.708.708l4 4a.5.5 0 00.708 0l4-4a.5.5 0 000-.708z" fill="currentColor"></path>
            </svg>
        </button>
        <button type="button" class="Slider_Home_Banner__next slider-button slider-button--next" name="next" aria-label="Next slide" aria-controls="Slider-template--16599720624378__1655078171bc129901" data-slick-id="home_banner" data-slick-button-next>
            <svg aria-hidden="true" focusable="false" role="presentation" class="icon icon-caret" viewBox="0 0 10 6">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M9.354.646a.5.5 0 00-.708 0L5 4.293 1.354.646a.5.5 0 00-.708.708l4 4a.5.5 0 00.708 0l4-4a.5.5 0 000-.708z" fill="currentColor"></path>
            </svg>
        </button>
    </div>
    <div class="Slider_Home_Banner owl-carousel owl-theme slideshow banner banner--medium grid grid--1-col slider slider--everywhere" aria-live="off" aria-atomic="true" data-autoplay="true" data-speed="9">
