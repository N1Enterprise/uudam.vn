<div class="section-template-padding page-width section-template__video-padding">
    <a href="{{ data_get($videoOutsideUI, 'redirect_url') }}" target="{{ data_get($videoOutsideUI, 'open_new_tab') ? '_bank' : '_self' }}">
        <div class="video-section__media deferred-media no-js-hidden gradient global-media-settings" style="padding-bottom: 56.25%;">
            <button class="video-section__poster media deferred-media__poster media--landscape" type="button" aria-label="Load video: DharmaCrafts Find Your Tranquil Space">
                <img class="image-lazy" srcset="{{ data_get($videoOutsideUI, 'image_path') }}" src="{{ data_get($videoOutsideUI, 'image_path') }}" sizes="(min-width: 1600px) 1500px, (min-width: 750px) calc(100vw - 10rem), 100vw" alt="Load video: DharmaCrafts Find Your Tranquil Space" loading="lazy" width="1920" height="1080">
