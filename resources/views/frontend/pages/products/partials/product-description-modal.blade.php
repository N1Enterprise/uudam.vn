<div class="product-modal-description">
    <product-modal data-description-modal-close class="product-media-modal media-modal">
        <button type="button" class="product-media-modal__toggle" data-description-modal-close>
        ...
        <div class="product-media-modal__content gradient" tabindex="0">
            ...
            <button type="button" class="act-button" data-description-modal-close class="button" style="margin-top: 10px; padding: 13px; margin-bottom: 60px;">Đã Đọc Xong</button>
        </div>
    </product-modal>
</div>
