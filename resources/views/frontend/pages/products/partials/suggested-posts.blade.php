<div class="blog color-background-1 gradient">
    <div class="page-width-desktop isolate section-template-padding">
        ...
        <div class="slider-mobile-gutter">
            <div class="owl-carousel owl-theme blog__posts articles-wrapper contains-card contains-card--standard grid grid--peek grid--2-col-tablet grid--3-col-desktop slider slider--tablet" style="margin: 0 -5px;" data-owl-id="Inventory_Related_Post" data-owl-items="3">
