                    ...
                    <tbody>
                        ...
                        <tr class="cart-item" id="CartItem-1">
                            ...
                            <td class="cart-item__details">
                                ...
                                <div class="product-option"> {{ format_price(data_get($item, 'price')) }} </div>
                                <dl></dl>
                            ...
                            <td class="cart-item__totals right medium-hide large-up-hide">
                                ...
                                <div class="cart-item__price-wrapper">
                                    <span class="price price--end"> {{ format_price(data_get($item, 'price')) }} </span>
                                </div>
                            </td>
                            <td class="cart-item__quantity">
                                <div class="cart-item__quantity-wrapper">
                                    ...
                                    <quantity-input class="quantity">
                                        ...
                                        <input class="quantity__input" type="number" name="updates[]" value="{{ data_get($item, 'quantity') }}" min="{{ data_get($item, 'inventory.min_order_quantity') }}" max="{{ data_get($item, 'inventory.stock_quantity') }}" aria-label="Quantity for {{ data_get($item, 'inventory.title') }}" data-index="1">
                                    ...
                                    <cart-remove-button data-index="1">
                                        <a href="javascript:void(0)" class="button button--tertiary" aria-label="Remove {{ data_get($item, 'inventory.title') }}">
