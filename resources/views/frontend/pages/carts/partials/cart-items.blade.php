                        ...
                        <td class="cart-item__quantity">
                            <div class="cart-item__quantity-wrapper">
                                ...
                                <cart-remove-button data-index="1">
                                    <a href="javascript:void(0)" cart-remove-button data-cart-id="{{ data_get($item, 'id') }}" class="button button--tertiary" aria-label="Remove {{ data_get($item, 'inventory.title') }}">
