						...
						<div class="tab-content">
							<div class="tab-pane active show" id="mainTab" role="tabpanel">
                                ...
                                <div class="form-group">
									...
									<input type="text" class="form-control {{ $errors->has('cta_label') ? 'is-invalid' : '' }}" name="cta_label" placeholder="{{ __('Nhập thứ tự ưu tiên') }}" value="{{ old('cta_label', $collection->cta_label) }}">
                                    @error('cta_label')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
								</div>
