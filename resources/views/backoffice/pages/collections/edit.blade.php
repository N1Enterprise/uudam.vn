			...
			<div class="k-portlet k-portlet--tabs">
				<div class="k-portlet__head">
					<div class="k-portlet__head-label">
						<h3 class="k-portlet__head-title">{{ __('Edit Collection') }}</h3>
					</div>
					...
					<div class="k-portlet__body">
						...
						<div class="tab-content">
							<div class="tab-pane active show" id="mainTab" role="tabpanel">
                                ...
                                <div class="form-group">
									<label>{{ __('Slug') }} *</label>
									<input type="text" class="form-control {{ $errors->has('slug') ? 'is-invalid' : '' }}" name="slug" placeholder="{{ __('Enter Slug') }}" value="{{ old('slug', $collection->slug) }}" required>
                                    @error('slug')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
								</div>
                                ...
                                <div class="form-group">
									...
									<input type="number" class="form-control {{ $errors->has('order') ? 'is-invalid' : '' }}" name="order" placeholder="{{ __('Enter Order') }}" value="{{ old('order', $collection->order) }}">
                                    @error('order')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
								</div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="upload_image_custom position-relative">
                                                <input type="text" data-image-ref-path="primary" data-image-ref-index="0" class="form-control image_primary_image_url" name="primary_image[path]" value="{{ old('primary_image.path', $collection->primary_image) }}" placeholder="{{ __('Upload Image or Input URL') }}" style="padding-right: 104px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="upload_image_custom position-relative">
                                                <input type="text" data-image-ref-path="cover" data-image-ref-index="0" class="form-control image_cover_image_url" name="cover_image[path]" value="{{ old('cover_image.path', $collection->cover_image) }}" placeholder="{{ __('Upload Image or Input URL') }}" style="padding-right: 104px;">
                                ...
                                <div class="form-group">
									...
									<input type="text" class="form-control {{ $errors->has('cta_label') ? 'is-invalid' : '' }}" name="cta_label" placeholder="{{ __('Enter Order') }}" value="{{ old('cta_label', $collection->cta_label) }}">
                                    @error('cta_label')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
								</div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="description" data-builder-ref="form_builder_dom" value="{{ old('description', json_encode($collection->description)) }}">
                                </div>

                                <div class="form-group">
									<label>{{ __('Meta Title') }}</label>
									<input type="text" class="form-control {{ $errors->has('meta_title') ? 'is-invalid' : '' }}" name="meta_title" placeholder="{{ __('Enter Slug') }}" value="{{ old('meta_title', $collection->meta_title) }}">
                                    @error('meta_title')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
								</div>
                                ...
                                <div class="form-group">
									...
									<input type="text" class="form-control {{ $errors->has('meta_description') ? 'is-invalid' : '' }}" name="meta_description" placeholder="{{ __('Enter Slug') }}" value="{{ old('meta_description', $collection->meta_description) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="inventories[]" title="--{{ __('Select Inventories') }}--" class="form-control k_selectpicker" data-live-search="true" multiple>
                                        ...
                                        <option value="{{ $inventory->id }}" data-slug="{{ $inventory->slug }}" {{ in_array($inventory->id, old('inventories', optional($collection->inventories)->pluck('id')->toArray())) ? 'selected' : '' }}>{{ $inventory->title }} (SKU: {{ $inventory->sku }})</option>
                                        @endforeach
                                    </select>
                                    @error('inventories')
                                    <div class="invalid-feedback">{{ $message }}</div>
