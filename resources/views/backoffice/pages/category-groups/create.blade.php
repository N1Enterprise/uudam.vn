	...
	<div class="row">
		<div class="col-md-6">
			...
			<div class="k-portlet k-portlet--tabs">
				...
				<!--begin::Form-->
				<form class="k-form" name="store_category_group" id="store_category_group" method="post" action="{{ route('bo.web.category-groups.store') }}" enctype="multipart/form-data">
					@csrf
						...
						<div class="tab-content">
							<div class="tab-pane active show" id="mainTab" role="tabpanel">
                                ...
                                <div class="form-group">
									...
									<input type="file" class="form-control" name="icon_image" placeholder="{{ __('Enter Icon Image') }}" value="{{ old('icon_image') }}" required>
								</div>
