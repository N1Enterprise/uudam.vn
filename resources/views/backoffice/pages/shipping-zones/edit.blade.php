	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="k-portlet k-portlet--tabs">
				...
				<!--begin::Form-->
				<form class="k-form" name="form_shipping_zones" id="form_shipping_zones" method="post" action="{{ route('bo.web.shipping-zones.update', $shippingZone->id) }}">
					@csrf
                    @method('PUT')
							...
							<div class="tab-pane active show" id="mainTab" role="tabpanel">
								...
								<div class="form-group row">
									...
									<div class="col-3">
										<span class="k-switch">
											<label>
												<input type="checkbox" {{ old('status', boolean($shippingZone->status) ? '1' : '0') == '1'  ? 'checked' : ''}} value="1" name="status"/>
												<span></span>
											</label>
										</span>
									</div>
