                    ...
                    <div class="k-portlet__body">
                        ...
                        <div class="form-group row">
                            <div class="col-lg-6">
                                ...
                                <input type="number" min="1" class="form-control" id="vip_level" name="vip_level" placeholder="{{ __('Enter VIP Level') }}" value="{{ old('vip_level', $vipSetting->vip_level) }}" required>
                            </div>
                            <div class="col-lg-6">
                                <label class="">{{ __('VIP Name') }} *</label>
                                <input type="text" class="form-control" id="vip_name" name="vip_name" placeholder="{{ __('Enter VIP name') }}" value="{{ old('vip_name', $vipSetting->vip_name) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
							...
							<div class="col-2">
								<span class="k-switch">
									<label>
										<input type="checkbox" {{ boolean(old('status', $vipSetting->status)) ? 'checked' : '' }} name="status" />
										<span></span>
									</label>
								</span>
							</div>
                                            ...
                                            <div class="form-group form-group-last row">
                                                <div class="col-lg-6 form-group-sub">
                                                    <input
                                                        ...
                                                        value="{{ old("min_deposit_per_transaction.{$row}", data_get($vipSetting, "min_deposit_per_transaction.{$row}")) }}"
                                                ...
                                                <div class="col-lg-6 form-group-sub">
                                                    <input
                                                        ...
                                                        value="{{ old("max_deposit_per_transaction.{$row}", data_get($vipSetting, "max_deposit_per_transaction.{$row}")) }}"
                                            ...
                                            <div class="form-group form-group-last row">
                                                <div class="col-lg-6 form-group-sub">
                                                    <input
                                                        ...
                                                        value="{{ old("min_deposit_per_daily.{$row}", data_get($vipSetting, "min_deposit_per_daily.{$row}")) }}"
                                                        placeholder="{{ __('Min Deposit') }}"
                                                        min="0">
                                                </div>
                                                <div class="col-lg-6 form-group-sub">
                                                    <input
                                                        ...
                                                        value="{{ old("max_deposit_per_daily.{$row}", data_get($vipSetting, "max_deposit_per_daily.{$row}")) }}"
                                                        placeholder="{{ __('Max Deposit') }}"
                                                        min="0">
                                                </div>
                                            </div>
                                    ...
                                    @foreach ($currencies as $currency)
                                        ...
                                        <div class="tab-pane {{ $loop->first ? 'active' : '' }}" id="max_withdraw_per_transaction_{{ $row }}" role="tabpanel">
                                            <input
                                                ...
                                                value="{{ old("max_withdraw_per_transaction.{$row}", data_get($vipSetting, "max_withdraw_per_transaction.{$row}")) }}"
                                                placeholder="{{ __('Max Withdraw Per Transaction') }}"
                                                min="0">
                                        </div>
                                    @endforeach
                                </div>
                                    ...
                                    @foreach ($currencies as $currency)
                                        ...
                                        <div class="tab-pane {{ $loop->first ? 'active' : '' }}" id="max_withdraw_per_daily_{{ $row }}" role="tabpanel">
                                            <input
                                                ...
                                                value="{{ old("max_withdraw_per_daily.{$row}", data_get($vipSetting, "max_withdraw_per_daily.{$row}")) }}"
                                                placeholder="{{ __('Max Withdraw Limit Daily') }}"
                                                min="0">
                                        </div>
                                    @endforeach
                                </div>
                                ...
                                <div class="col-lg-12 border border-secondary p-3 mt-4">
                                    <div class="box-title col-lg-3 col-md-3 col-sm-4" style="transform: translateY(-30px)">
                                        <select name="upgrade_requirement[operator]" class="form-control">
                                            <option {{ old("upgrade_requirement.operator", $vipSetting->upgrade_requirement_operator) == 'and' ? 'selected' : '' }} value="and">{{ __('AND') }}</option>
                                            <option {{ old("upgrade_requirement.operator", $vipSetting->upgrade_requirement_operator) == 'or' ? 'selected' : '' }} value="or">{{ __('OR') }}</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="box-content">
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                value="{{ old("upgrade_requirement.point", $vipSetting->upgrade_requirement_point) }}"
                                                min="0.01"
                                                step="0.01"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input
                                                                    ...
                                                                    value="{{ old("upgrade_requirement.currencies.{$row}.bet_amount", $vipSetting->getUpgradeBetAmountRequirementByCurrencyCode($row)) }}"
