			...
			<div class="k-portlet k-portlet--tabs">
				<div class="k-portlet__head">
					<div class="k-portlet__head-label">
						<h3 class="k-portlet__head-title">{{ __('Add Payment Provider') }}</h3>
					</div>
				...
				<!--begin::Form-->
				<form class="k-form" name="form_payment-providers" id="form_payment-providers" method="post" action="{{ route('bo.web.payment-providers.store') }}">
					@csrf
							...
							<div class="tab-pane active show" id="mainTab" role="tabpanel">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control k_selectpicker" id="payment_type" name="payment_type">
                                        ...
                                        <option {{ old('payment_type') == $key ? 'selected' : '' }} value="{{ $key }}">{{ $label }}</option>
                                        @endforeach
                                    </select>
                                </div>
