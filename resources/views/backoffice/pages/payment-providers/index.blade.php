...
<div class="k-content__body	k-grid__item k-grid__item--fluid" id="k_content_body">
	...
	<div class="k-portlet k-portlet--mobile">
		...
		<div class="k-portlet__body">
			<!--begin: Datatable -->
			<table data-request-url="{{ route('bo.api.payment-providers.index') }}" class="datatable table table-striped table-bordered table-hover table-checkable fs-table-object">
				<thead>
					<tr>
						...
						<th data-property="supported_currencies">{{ __('Supported Currencies') }}</th>
