	...
	<div class="row">
		<div class="col-md-9">
			...
			<div class="k-portlet k-portlet--tabs">
				...
				<!--begin::Form-->
				<form class="k-form" name="form_shipping_options" id="form_shipping_options" method="post" action="{{ route('bo.web.shipping-options.update', $shippingOption->id) }}" enctype="multipart/form-data">
					@csrf
					@method('PUT')
						...
						<div class="tab-content">
							<div class="tab-pane active show" id="mainTab" role="tabpanel">
								...
								<div class="form-group">
									...
									<input type="number" class="form-control {{ $errors->has('order') ? 'is-invalid' : '' }}" name="order" placeholder="{{ __('Enter Order') }}" value="{{ old('order', $shippingOption->order) }}">
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-3">
										<span class="k-switch">
											<label>
												<input type="checkbox" {{ old('status', boolean($shippingOption->status) ? '1' : '0') == '1'  ? 'checked' : ''}} value="1" name="status" />
												<span></span>
											</label>
										</span>
									</div>
								...
								<div class="row">
									...
									<div class="col-3">
										<span class="k-switch">
											<label>
												<input type="checkbox" {{ boolean(old('display_on_frontend', $shippingOption->display_on_frontend))  ? 'checked' : ''}} value="1" name="display_on_frontend" />
												<span></span>
											</label>
										</span>
									</div>
