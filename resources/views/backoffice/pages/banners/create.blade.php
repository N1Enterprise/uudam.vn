                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="upload_image_custom position-relative">
                                                ...
                                                <div data-image-ref-wapper="desktop" data-image-ref-index="0" class="d-none w-100 position-absolute d-none" style="top: 50%; left: 4px; transform: translateY(-50%); height: 90%; background-color: #fff;">
                                        ...
                                        <div class="col-md-6">
                                            <div class="image_desktop_image_review">
                                                <div data-image-ref-review-wapper="desktop" data-image-ref-index="0" class="d-none" style="width: 100px; height: 100px; border: 1px solid #ccc;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="upload_image_custom position-relative">
                                                ...
                                                <div data-image-ref-wapper="mobile" data-image-ref-index="0" class="d-none w-100 position-absolute d-none" style="top: 50%; left: 4px; transform: translateY(-50%); height: 90%; background-color: #fff;">
                                                    <div class="d-flex align-items-center h-100">
                                        ...
                                        <div class="col-md-6">
                                            <div class="image_mobile_image_review">
                                                <div data-image-ref-review-wapper="mobile" data-image-ref-index="0" class="d-none" style="width: 100px; height: 100px; border: 1px solid #ccc;">
