			...
			<div class="k-portlet k-portlet--tabs">
				<div class="k-portlet__head">
					<div class="k-portlet__head-label">
						<h3 class="k-portlet__head-title">{{ __('Add Post') }}</h3>
					</div>
				...
				<!--begin::Form-->
				<form class="k-form" name="form_posts" id="form_posts" method="post" action="{{ route('bo.web.posts.store') }}" enctype="multipart/form-data">
					@csrf
					<div class="k-portlet__body">
						...
						<div class="tab-content">
							<div class="tab-pane active show" id="mainTab" role="tabpanel">
                                ...
                                <div class="form-group">
                                    <x-content-editor id="post_content" label="Content" name="content" value="{{ old('content') }}" />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        name="post_at"
                                        value="{{ old('post_at', date('Y-m-d h:i:s', strtotime(now()))) }}"
                                    >
                                </div>
