							...
							<div class="tab-pane active show" id="mainTab" role="tabpanel">
                                ...
                                <div data-menu-type-tab-key="1" data-menu-type="normal">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="meta[title]" placeholder="{{ __('Enter Menu Title') }}" value="{{ old('meta.title') }}">
                                    </div>

                                    <div class="form-group">
                                        <label>{{ __('Redirect Url') }}</label>
                                        <input type="text" class="form-control" name="meta[redirect_url]" placeholder="{{ __('Enter Redirect Url') }}" value="{{ old('meta.redirect_url') }}">
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="upload_image_custom position-relative">
                                                    <input type="text" data-image-ref-path="primary" data-image-ref-index="0" class="form-control image_primary_image_url" name="meta[image][path]" placeholder="{{ __('Upload Image or Input URL') }}" style="padding-right: 104px;">
