...
@php
	$title = __('Tạo giá cước vận chuyển');
			...
			<div class="k-portlet k-portlet--tabs">
				<div class="k-portlet__head">
					<div class="k-portlet__head-label">
						<h3 class="k-portlet__head-title">{{ __('Tạo giá cước vận chuyển') }}</h3>
					</div>
						...
						<div class="tab-content">
							<div class="tab-pane active show" id="mainTab" role="tabpanel">
                                ...
                                <div class="form-group">
									...
									<input type="text" class="form-control" name="delivery_takes" placeholder="{{ __('2-5 ngày') }}" value="{{ old('delivery_takes') }}" required>
								</div>
