...
@php
	$title = __('Create Shipping Provider');
			...
			<div class="k-portlet k-portlet--tabs">
				<div class="k-portlet__head">
					<div class="k-portlet__head-label">
						<h3 class="k-portlet__head-title">{{ __('Create Shipping Provider') }}</h3>
					</div>
				...
				<!--begin::Form-->
				<form class="k-form" name="form_shipping_providers" id="form_shipping_providers" method="post" action="{{ route('bo.web.shipping-providers.store') }}" enctype="multipart/form-data">
					@csrf
