...
<html lang="en">
    ...
    <body>
        <main id="content" role="main" class="main">
            <div class="position-fixed top-0 right-0 left-0 bg-img-hero" style="height: 32rem; background-image: url({{ asset('backoffice/assets/svg/abstract-bg-4.svg') }});">
            ...
            <div class="container py-5 py-sm-7">
                <a class="d-flex justify-content-center mb-5" href="javascript:void(0)">
                    <img class="z-index-2" src="{{ asset('backoffice/assets\svg\main-logo.svg') }}" alt="{{ __('Image Description') }}" style="width: 8rem;">
                </a>
