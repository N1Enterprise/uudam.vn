                                ...
                                <tbody>
                                    <tr>
                                        <td style="line-height:24px;font-size:16px;width:100%;margin:0;padding:40px" align="left" bgcolor="#ffffff">
                                            <div style="padding-top:0;padding-bottom:20px;font-weight:530!important;vertical-align:baseline;font-size:18px;line-height:18px;margin:0" align="left">Ưu Đàm thân chào {{ $user }},</div>
                                            <div>
                                                <div style="padding-top:20">Để thay đổi mật khẩu vui lòng nhấn nút bên dưới:</div>
                                                <p></p>
                                                <h2 style="text-align:center">
                                                    <a href="{{ $url }}" style="color: #000; font-weight: bold; text-decoration: underline;">Thay đổi mật khẩu</button>
                                                </h2>
                                                <p></p>
                                                <div style="padding-top:20">
                                                    <strong>Lưu ý</strong>: Nếu bạn không thực hiện thay đổi mật khẩu nhưng vẫn nhận được email này, thì bạn nên thay đổi mật khẩu ngay!
                                                </div>
                                                <p>
