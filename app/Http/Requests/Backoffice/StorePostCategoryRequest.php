...
class StorePostCategoryRequest extends BaseFormRequest implements StorePostCategoryRequestContract
{
    public function rules(): array
    {
        return [
            'name' => ['required', 'max:255'],
            'slug' => ['required', 'alpha-dash', 'max:255', Rule::unique(PostCategory::class, 'slug')],
