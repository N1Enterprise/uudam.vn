...
abstract class BaseRepository implements BaseRepositoryContract
{
    ...
    {
        return request()->get('per_page', config('stevephamhi_core.paginate.limit', 20));
    }
    ...
    public function findOrFail($id, $columns = ['*'])
    {
        ...
        if (! $model) {
            throw new ModelNotFoundException('Invalid '.class_basename($this->model()));
        }
    ...
    protected function getPaginateLimit($limit)
    {
        ...
        $maxLimit = config('stevephamhi_core.paginate.max', 100);
    ...
    public function throwModelNotFoundException()
    {
        throw new ModelNotFoundException('Invalid '.class_basename($this->model()));
    }
