...
(() => {
/*!*************************************************!*\
  !*** ./resources/src/frontend/js/cart-index.js ***!
  \*************************************************/
__webpack_require__.r(__webpack_exports__);
...
var MY_CART = {
  ...
  onQuantity: function onQuantity() {
    $.each($('quantity-input.quantity'), function (index, element) {
      var cartID = $(element).attr('data-cart-id');
      var quantityID = "cart_item_".concat(cartID);
      var $cartItem = $(element).parents('tr');
      utils_quantity(quantityID, {
        callbacks: {
          onChange: function onChange(value) {
            ...
            function process() {
              MY_CART.updateCartItemQuantity(cartID, value, function (_ref) {
              ...
              case 3:
                ...
                $.ajax({
                  ...
                  success: function success() {
                    ...
                    $self.parents('');
                    _user_order_cart__WEBPACK_IMPORTED_MODULE_0__["default"].updateCartInfo(function (data) {
                      if (data !== null && data !== void 0 && data.total_items || 0 == 0) {
                        utils_helper.reload();
                      }
                    });
                  },
