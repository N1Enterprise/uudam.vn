...
/*!*******************************************************!*\
  !*** ./resources/src/frontend/js/collection-index.js ***!
  \*******************************************************/
...
var COLLECTION_LINKED_INVENTORIES = {
  ...
  loadInitInventories: function loadInitInventories() {
    COLLECTION_LINKED_INVENTORIES.ajaxInventories({}, {
      ...
      successCb: function successCb(response) {
        var htmlInventories = COLLECTION_LINKED_INVENTORIES.buildHTMLInventories((response === null || response === void 0 ? void 0 : response.data) || []);
  ...
  loadBySortInventories: function loadBySortInventories() {
    COLLECTION_LINKED_INVENTORIES.elements.sort_by.on('change', function () {
      var value = $(this).val();
      var currentPage = COLLECTION_LINKED_INVENTORIES.elements.btn_load_more.attr('data-current-page');
      COLLECTION_LINKED_INVENTORIES.elements.sort_by.find('option').prop('selected', false);
      COLLECTION_LINKED_INVENTORIES.elements.sort_by.find("option[value=\"".concat(value, "\"]")).prop('selected', true);
      COLLECTION_LINKED_INVENTORIES.ajaxInventories(_defineProperty({
        page: currentPage,
        sort_by: value
      }, "page", 1), {
        beforeSendCb: function beforeSendCb() {
  ...
  setPagination: function setPagination(response) {
    ...
    if (response !== null && response !== void 0 && response.has_more && response !== null && response !== void 0 && response.current_page) {
      ...
      COLLECTION_LINKED_INVENTORIES.elements.btn_load_more.attr('href', "".concat(COLLECTION_LINKED_INVENTORIES.baseRoute, "?page=").concat(response.current_page + 1));
